...
$('#headShot').attr('src', profilePic);

const writeBio = () => {
  const domString = `
  <div class="card text-center" style="width: 400px;">
        <h1>Mary Rys</h1>
        <img class="card-img-top" src="https://s3-us-west-1.amazonaws.com/co-directory-images/mary-rys-301b2752.jpg" alt="profile_image" id="headShot"></img>
        <div class="card-body">
